...
SECRET_KEY = 'django-insecure-v%j55ke%hf5^=t@)(av&2^8bp2klbb@^579i95&07%bs1vfr_&'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'postgres',     # same as you created in RDS
        'USER': 'postgres',     # the master username you set in RDS
        'PASSWORD': 'Baibhavrath',
        'HOST': 'database-1.cluster-crgm26yq64y6.ap-south-1.rds.amazonaws.com',  # RDS endpoint (no port here)
